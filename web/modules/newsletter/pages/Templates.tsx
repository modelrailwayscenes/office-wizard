...
export default function Templates() {
  return (
    <div className="p-8 max-w-6xl mx-auto bg-slate-950 min-h-full animate-fade-in">
      ...
      <p className="text-slate-400 mb-8">Pre-built newsletter layouts ready to customize</p>
            ...
            return (
              <CarouselItem key={t.id} className="pl-4 md:basis-1/2 lg:basis-1/3">
                <Link to="/marketing/newsletter/create">
                  <Card className="bg-slate-800/50 border-slate-700 overflow-hidden hover:border-slate-600 transition-shadow cursor-pointer group">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge variant="secondary" className="text-xs bg-slate-700 text-slate-300 border-slate-600">{t.defaultBlocks.length} blocks</Badge>
                        <Badge variant="outline" className="border-slate-600 text-slate-300 text-xs">{t.defaultDensity}</Badge>
                      </div>
                    </div>
                  </Card>
                </Link>
