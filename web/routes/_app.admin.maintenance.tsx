...
export default function AdminMaintenancePage() {
  const sections = [
    { id: "support-admin", label: "Support Admin" },
    { id: "module-flags", label: "Module Feature Flags" },
  ...
  const [activeSection, setActiveSection] = useState<SectionId>("support-admin");
  ...
  return (
    <div className="px-6 py-6 md:px-8">
      <div className="flex h-[calc(100vh-7rem)] overflow-hidden rounded-xl border border-border bg-card/30">
        <aside className="w-64 border-r border-border bg-card/60 p-3">
        ...
        <div className="flex-1 overflow-auto p-4 space-y-4 md:p-5">
          ...
          {activeSection === "maintenance-jobs" ? (
            <RefinedCard className="p-5">
